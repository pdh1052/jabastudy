...
public class Test {
	...
	public void me72(String msg) throws DoNotSwearException1 {
		if (msg.equals("개새끼")) {
	...
	public void me71(String msg) {
		if (msg.equals("개새끼")) {
			throw new DoNotSwearException2("욕설금지");
	...
	public void me61() {
		...
		try {
			...
			System.out.println("성공/실패 상관없이 무조건 실행");
	...
	public void me6(int num) {
		...
		try {
			...
			System.out.println("성공/실패와 상관없이 반드시 실행되는 코드");
			System.out.println("return보다 더 강력하다");
		}
